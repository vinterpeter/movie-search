...
import type { Movie, TVShow, TMDBResponse, MediaType } from '../types/movie';
...
export const useMovies = (options: UseMoviesOptions = {}): UseMoviesReturn => {
  ...
  const fetchItems = useCallback(
    ...
    [mediaType, options.genres, options.certification, options.providers, options.sortBy, options.minRating, options.yearFrom, options.yearTo]
  );
